...
const Dashboard = ({ onDismiss }) =>
  <Scroller className="padding-b:40">
    ...
    <div>
      ...
      elit. Itaque, sequi? Consequuntur inventore nulla
      ratione vitae obcaecati voluptatem animi molestiae
      ipsam et adipisci illo reiciendis saepe doloremque,
      quae perspiciatis iure vero.
    </div>
  </Scroller>;
